defmodule GalaxiesWeb.PlayerAuth do
  ...
  def log_out_player(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      GalaxiesWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  the current_player:
      ...
      defmodule GalaxiesWeb.PageLive do
        use GalaxiesWeb, :live_view

        on_mount {GalaxiesWeb.PlayerAuth, :mount_current_player}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{GalaxiesWeb.PlayerAuth, :ensure_authenticated}] do
  ...
  defp signed_in_path(_conn), do: ~p"/overview"
end
